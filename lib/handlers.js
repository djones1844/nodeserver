...
handlers._checks.post = (data, callback) => {
  // validate inputs
  let protocal = typeof(data.payload.protocal) == 'string' && ['http', 'https'].indexOf(data.payload.protocal) > -1 ? data.payload.protocal : false    
...
// Check - put
// Required data: id
// Optional data: protocal, url, method, sucessCodes, timeoutSeconds (one must be supplied)
