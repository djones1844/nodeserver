...
workers.alertUsersToStatusChange = newCheckData => {
  ...
  helpers.sendTwilioSms(newCheckData.userPhone, msg, err => {
    if (!err){
      ...
      console.log('Error: Could not send sms alert to a person who had a state change')
    }
  })
}


workers.logv= (originalCheckData, checkOutcome, state, alertWarranted, timeOfCheck) =>{
  // form the log data
  let logdata = {
